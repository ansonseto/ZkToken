...
const account = require("../generatejs/generate_accounts.js");
const balanceLeaf = require("../generatejs/generate_balance_leaf.js");
const txLeaf = require("../generatejs/generate_tx_leaf.js");
const merkle = require("../generatejs/MiMCMerkle.js")
const update = require("../generatejs/update.js")
const eddsa = require("../src/eddsa.js");

const TX_DEPTH = bigInt('2')
const BAL_DEPTH = bigInt('4')
...
const depth = bigInt('2')**TX_DEPTH
const txProofs = new Array(depth)
